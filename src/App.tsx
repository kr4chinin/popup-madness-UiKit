	...
	const [user, setUser] = useState<User>({
		...
		friends: [
			...
			},
			{
				...
				bio: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae laborum aliquam suscipit excepturi nobis impedit nulla perspiciatis fuga deserunt molestias sed consequatur a maiores esse, voluptatem facere eius dicta explicabo qui iure tempora quo. Obcaecati ad totam, optio pariatur non beatae? Iure architecto ipsam quisquam reprehenderit. Impedit nihil inventore provident!',
				friends: []
			},
			{
				id: '4',
